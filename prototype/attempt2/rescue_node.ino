...
// >>> FILL THESE IN <<<
// ---------------------------------------------------------------------------
const char* HOME_WIFI_SSID     = "YOUR_INTERNET_WIFI_SSID";
const char* HOME_WIFI_PASSWORD = "YOUR_INTERNET_WIFI_PASSWORD";

const char* BACKEND_URL     = "https://your-backend.example.com/api/rescue-alert"; // <-- your endpoint
...
void setup() {
  ...
  server.begin();
  Serial.println("[HTTP] Web server started, listening for mesh messages on /relay");
}
